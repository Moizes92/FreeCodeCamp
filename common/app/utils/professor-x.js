...
import invarient from 'invarient';
...
const log = debug('freecc:professerx');
...
export default function contain(options = {}, Component) {
  ...
  return class Container extends React.Component {
    ...
    componentDidMount() {
      ...
      if (!isActionable) {
        log('container is not actionable');
        return null;
      }
